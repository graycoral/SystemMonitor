...
extern DiskUsageResponseDefaultTypeInternal _DiskUsageResponse_default_instance_;
class MemoryUsageRequest;
class MemoryUsageRequestDefaultTypeInternal;
extern MemoryUsageRequestDefaultTypeInternal _MemoryUsageRequest_default_instance_;
class MemoryUsageResponse;
class MemoryUsageResponseDefaultTypeInternal;
extern MemoryUsageResponseDefaultTypeInternal _MemoryUsageResponse_default_instance_;
}  // namespace systemmonitor
namespace google {
namespace protobuf {
...
template<> ::systemmonitor::DiskUsageRequest* Arena::CreateMaybeMessage<::systemmonitor::DiskUsageRequest>(Arena*);
template<> ::systemmonitor::DiskUsageResponse* Arena::CreateMaybeMessage<::systemmonitor::DiskUsageResponse>(Arena*);
template<> ::systemmonitor::MemoryUsageRequest* Arena::CreateMaybeMessage<::systemmonitor::MemoryUsageRequest>(Arena*);
template<> ::systemmonitor::MemoryUsageResponse* Arena::CreateMaybeMessage<::systemmonitor::MemoryUsageResponse>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace systemmonitor {
...
class MemoryUsageRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:systemmonitor.MemoryUsageRequest) */ {
 public:
  ...
  friend void swap(MemoryUsageRequest& a, MemoryUsageRequest& b) {
    a.Swap(&b);
  }
...
class DiskUsageRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:systemmonitor.DiskUsageRequest) */ {
 public:
  ...
  #if LANG_CXX11
  DiskUsageRequest(DiskUsageRequest&& from) noexcept
    : DiskUsageRequest() {
    *this = ::std::move(from);
  }
  ...
  friend void swap(DiskUsageRequest& a, DiskUsageRequest& b) {
    a.Swap(&b);
  }
...
class DiskUsageResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:systemmonitor.DiskUsageResponse) */ {
 public:
  ...
  #if LANG_CXX11
  DiskUsageResponse(DiskUsageResponse&& from) noexcept
    : DiskUsageResponse() {
    *this = ::std::move(from);
  }
  ...
  friend void swap(DiskUsageResponse& a, DiskUsageResponse& b) {
    a.Swap(&b);
  }
...
// float used_memory_mb = 1;
inline void MemoryUsageResponse::clear_used_memory_mb() {
  used_memory_mb_ = 0;
}
...
// float used_disk_gb = 1;
inline void DiskUsageResponse::clear_used_disk_gb() {
  used_disk_gb_ = 0;
}
...
// float total_disk_gb = 2;
inline void DiskUsageResponse::clear_total_disk_gb() {
  total_disk_gb_ = 0;
}
